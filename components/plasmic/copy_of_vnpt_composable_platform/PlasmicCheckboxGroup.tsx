...
import Checkbox from "../../Checkbox"; // plasmic-import: CMZcQ9ZEiA4B/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: rZ7IzsClTj9T/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__iXrUy)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__p5XT6)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__pu4BM)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___8Aezo)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
