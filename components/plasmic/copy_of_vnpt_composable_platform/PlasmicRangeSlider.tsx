...
import SliderThumb from "../../SliderThumb"; // plasmic-import: kyo6T8U_padg/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: xCqgJpno_-ld/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__yo2Gj)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__nTkjO)}>
        <div
