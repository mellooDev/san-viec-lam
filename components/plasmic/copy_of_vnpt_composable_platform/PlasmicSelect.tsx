...
import MenuPopover from "../../MenuPopover"; // plasmic-import: hVKiNteBdFsg/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Q9DPvojwXDcb/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__gzIzh)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
