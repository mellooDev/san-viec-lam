...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: DQ2GcBDcLra1/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ej0PG)}>
        <div className={classNames(projectcss.all, sty.freeBox__fgk7K)} />
      </div>
      {renderPlasmicSlot({
