...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: CMZcQ9ZEiA4B/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: W91-YxRbfKdk/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: dlw5oiLEAyf9/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__wp3Kn)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___4MelM)}
            role={"img"}
          />
        ) : null}
      </div>
