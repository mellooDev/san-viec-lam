...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 8zjSwXU6lca-/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___4H252)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__kD6Lg)}>
            <div
              className={classNames(
                projectcss.all,
